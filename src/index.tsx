...
export module Analytics {
  ...
  export class Client {
    ...
    public async track(
      ...
      await this.middlewares.run(
        'track',
        { event, properties, integrations: options.integrations || {} },
        options.context || {}
      );
    }
    ...
    public async screen(
      ...
      await this.middlewares.run(
        'screen',
        { name, properties, integrations: options.integrations || {} },
        options.context || {}
      );
    }
    ...
    public async identify(
      ...
      await this.middlewares.run(
        'identify',
        { user, traits, options, integrations: options.integrations || {} },
        options.context || {}
      );
    }
    ...
    public async group(
      ...
      await this.middlewares.run(
        'group',
        { groupId, traits, integrations: options.integrations || {} },
        options.context || {}
      );
    }
    ...
    public async alias(newId: string, options: Options = {}) {
      await this.middlewares.run(
        'alias',
        { newId, integrations: options.integrations || {} },
        options.context || {}
      );
    }
