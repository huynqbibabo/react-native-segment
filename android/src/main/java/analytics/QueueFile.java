...
public class QueueFile implements Closeable {
    private static final Logger LOGGER = Logger.getLogger(analytics.QueueFile.class.getName());
     ...
     * So long as the underlying file system supports atomic segment writes, changes to the
