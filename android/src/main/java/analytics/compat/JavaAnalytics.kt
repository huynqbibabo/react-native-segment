...
/**
 * This class is merely a wrapper of {@link Analytics analytics.Analytics}
...
class JavaAnalytics private constructor() {
     ...
     *          through {@link ConfigurationBuilder analytics.compat.ConfigurationBuilder}
     */
    ...
    /**
     * A constructor takes an instance of {@link Analytics analytics.Analytics}
     ...
     *          {@link Builder analytics.compat.Builder}
     ...
     *
     * @param name Name of the action
     * @param serializable an object that implements {@link JsonSerializable analytics.compat.JsonSerializable}
     * @see <a href="https://segment.com/docs/spec/track/">Track Documentation</a>
     */
